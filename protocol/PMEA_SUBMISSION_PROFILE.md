...
| Generative AI disclosure | Permitted uses must be disclosed in Acknowledgements with model/version and purpose; authors retain responsibility | Disclosure identifies OpenAI Codex desktop, model `gpt-5.6-sol`, and its roles in code drafting and author-directed code review, command execution, audit-document preparation, code-development planning, literature organization, and language editing; authors retain responsibility | Pass |
